            ...
            <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-4">
                        ...
                        <div class="mt-6">
                            ...
                            <div class="flex justify-between mb-1">
                                <span id="progress-text" class="text-sm font-medium text-gray-700">1/4 Pertanyaan</span>
                                <span id="progress-percent" class="text-sm font-medium text-gray-700">25%</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2.5">
                                <div id="progress-bar" class="progress-bar bg-blue-600 h-2.5 rounded-full" style="width: 25%"></div>
                            </div>
                        </div>

                        <div class="mt-6 pt-4 border-t">
                            <button id="submit-quiz" class="w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-lg flex items-center justify-center">
                ...
                <div class="w-full lg:w-3/4">
                    <form id="quiz-form" class="quiz-card bg-white rounded-lg shadow-sm overflow-hidden">
                        ...
                        <!-- Question Body -->
                        <div class="p-6">
                            <p id="question-text" class="font-medium text-gray-800 mb-6">Berapakah hasil dari 25 + 37?</p>
