            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="#" class="bg-indigo-600 text-white px-8 py-3 rounded-lg hover:bg-indigo-700 transition-colors" id="mulaiMembaca">
                            Mulai E-Learning
                        </a>
                        <a href="#" class="bg-white text-indigo-600 border-2 border-indigo-600 px-8 py-3 rounded-lg hover:bg-indigo-50 transition-colors" id="pelajariLebih">
                ...
                <!-- Hero Image Lokal -->
                <div class="relative">
                    <img src="public/assets/images/vactor.png" 
                         alt="Hero Image" 
