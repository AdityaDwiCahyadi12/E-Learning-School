...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        // Persiapkan query untuk mencari user berdasarkan email
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            if ($user && password_verify($password, $user['password'])) {
                // Jika login berhasil, simpan session
                $_SESSION['user'] = [
                    'id' => $user['id'],  // Ganti 'id_user' menjadi 'id' sesuai struktur tabel
                    'nama' => $user['full_name'],  // Ganti 'nama' menjadi 'full_name'
                    'role' => $user['role']
                ];
